...
$result = query("SELECT tr_barang_out.barang_out, tr_barang_out.kode_brg, m_barang.nama_brg, m_barang.uom, tr_barang_out.qty, tr_barang_out.status FROM tr_barang_out INNER JOIN m_barang ON m_barang.kode_brg = tr_barang_out.kode_brg");
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Master Barang OUT</h3>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
