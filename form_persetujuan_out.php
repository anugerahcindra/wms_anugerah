...
$result = query("SELECT tr_barang_out.id, tr_barang_out.barang_out, tr_barang_out.kode_brg, m_barang.nama_brg, m_barang.uom, tr_barang_out.qty, tr_barang_out.status FROM tr_barang_out INNER JOIN m_barang ON m_barang.kode_brg = tr_barang_out.kode_brg WHERE tr_barang_out.status = 'Draft';");
...
<html lang="en">
  <head>
    ...
    <title>Warehouse Management System | Persetujuan Keluar</title>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Form Persetujuan Keluar</h3>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table class="table table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th class="text-center" colspan="2">Konfirmasi</th>
                          <th class="text-center">Kode Transaksi OUT</th>
			          ...
			          <?php foreach($result as $row) : ?>
                        <tr class="text-center">
                          <td><?= $i; ?></td>
                          <td>
                                <a onclick="return confirm('yakin menyetujui transaksi?')" href="approveOUT.php?id=<?= $row["id"]; ?>">
                                <button type="submit" name="approve" class="btn btn-warning">Approved</button>
                                </a>
                          </td>
                          <td>
                                <a href="rejectOUT.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin reject barang?');">
                                    <button type="submit" name="cancel" class="btn btn-danger">Reject</button>
                                </a>
                          </td>
                          <td><?= $row["barang_out"]; ?></td>
                          <td><?= $row["kode_brg"]; ?></td>
                          <td><?= $row["nama_brg"]; ?></td>
                          <td><?= $row["uom"]; ?></td>
                          <td><?= $row["qty"]; ?></td>
