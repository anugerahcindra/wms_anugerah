...
if(isset($_POST['submit']) ){
	...
	if( barang_out($_POST) > 0) {
		echo "<script>
				alert('Transaksi barang keluar sukses!');
				document.location.href = 'm_barang_out.php';
			  </script>";
	} else {
		echo "<script>
...
<html lang="en">
  <head>
    ...
    <title>Warehouse Management System | Transaksi OUT</title>
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="TambahData.php" class="nav-link">Tambah Data</a>
          </li>
              ...
              <div class="col-md-12">
                ...
                <div class="card card-info">
                  <div class="card-header">
                    <h3 class="card-title">Form Barang IN</h3>
                  </div>
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="kode_brg" class="col-sm-2 col-form-label"
                          >Kode Transaksi OUT</label
                        >
                        <div class="col-sm-10">
                          <input
                            type="text"
