...
$result = query("SELECT tr_barang_in.id, tr_barang_in.kode_transaksi_in, tr_barang_in.kode_brg, m_barang.nama_brg, m_barang.uom, tr_barang_in.qty, tr_barang_in.status FROM tr_barang_in INNER JOIN m_barang ON m_barang.kode_brg = tr_barang_in.kode_brg WHERE tr_barang_in.status = 'Draft';");
...
<html lang="en">
  <head>
    ...
    <title>Warehouse Management System | Persetujuan Masuk</title>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Form Persetujuan Masuk</h3>
                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table class="table table-bordered">
			          ...
			          <?php foreach($result as $row) : ?>
                        <tr class="text-center">
                          ...
                          <td>
                                <a href="reject.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin reject barang?');">
